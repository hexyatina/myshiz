...
racket = Racket("racket.png", 630, 100, 75, 25, 7)
racket2 = Racket("racket.png", 20, 100, 75, 25, 7)
...
while run:
    ...
    if not finish:
        ...
        '''colides = sprite.spritecollide(racket, ball, False, False)
        colides1 = sprite.spritecollide(racket2, ball, False, False)'''
    display.update()
    clock.tick(60)